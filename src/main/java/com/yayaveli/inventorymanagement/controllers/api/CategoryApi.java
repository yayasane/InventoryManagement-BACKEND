...
public interface CategoryApi {
        ...
        @GetMapping(value = "/byCategoryCode/{categoryCode}", produces = MediaType.APPLICATION_JSON_VALUE)
        ...
        ResponseEntity<CategoryDto> findByCategoryCode(@ApiParam(value = "Accepted Value {CAT1, CAT2, CAT3}") @PathVariable String categoryCode);
